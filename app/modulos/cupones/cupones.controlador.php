...
class CuponesControlador
{
    ...
    public function ctrActualizarCupones()
    {
        if (isset($_POST['btnActualizarCupon'])) {
            ...
            $crearCupon = CuponesModelo::mdlActualizarCupones($_POST);

            if ($crearCupon) {
                return array(
                    'status' => true,
                    'mensaje' => 'Cupón editado con éxito listo para su uso',
                    'pagina' => HTTP_HOST . 'cupones'
                );
            } else {
                return array(
    ...
    public function ctrEliminarCupones($cps_codigo)
    {
        
        $eliminar = CuponesModelo::mdlEliminarCupones($cps_codigo);
        if($eliminar){
            
            return array(
                'status' => true,
                'mensaje' => 'El cupon se elimino correctamente.',
                'pagina' => HTTP_HOST . 'cupones'
            );
            ...
            return array(
                'status' => false,
                'mensaje' => 'El cupon no se elimino. Intentelo nuevamente.',
                'pagina' => HTTP_HOST . 'cupones'
            );
        }
